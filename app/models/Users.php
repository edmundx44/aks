...
class Users extends Model {
	...
	public function __construct($user='') {
		...
		if($user != '') {
			if(is_int($user)) $u = $this->_db->findFirst('users',['conditions'=>'id = ?', 'bind'=>[$user]],'App\Models\Users');
			else $u = $this->_db->findFirst('users', ['conditions'=>'username = ?','bind'=>[$user]],'App\Models\Users');
	...
	public function validator(){
		...
		if($this->isNew())$this->runValidation(new MatchesValidator($this,['field'=>'password','rule'=>$this->_confirm,'msg'=>"Your passwords do not match"]));      
	}
