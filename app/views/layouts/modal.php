		...
		<div class="modal-content crm-modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<br/>
					<br/>
					<div class="col-12 cr-txtbox-problem-div">
						<div class="user-input-wrp">
							<br/>
...
<div class="modal fade" id="report-recheck-modal" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content rrl-modal-content">
			<div class="modal-header">
				<h3>RECHECK LOG</h3>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
			<div class="modal-body">
				<table class="rrl-mb-table">
					<thead>
						<tr class="rrl-mb-thead-tr">
							<td class="rrl-mb-thead-td">FEEDBACK</td>
							<td class="rrl-mb-thead-td">FEED</td>
							<td class="rrl-mb-thead-td">SITE</td>
							<td class="rrl-mb-thead-td">CHECKER</td>
							<td class="rrl-mb-thead-td">DATE</td>
						</tr> 
					</thead>
...
<div class="modal fade" id="report-modal-confirmation" role="dialog">
	<div class="modal-dialog modal-md">
		<div class="modal-content cfm-modal-content">
			<div class="modal-body">
				<div class="modal-content-header row">
					<div class="col-12">
						<h6 id="confirmation-header-tittle" class="float-left confirmation-tittle"></h6>
						<button type="button" class="close float-right cfm-modal-close" data-dismiss="modal"><span class="cfm-modal-close-span">&times;</span></button>
					</div>
				</div>
				<div class="row">
...
<!-- report recheck additional info log modal -->
<div class="modal fade" id="open-additional-info" role="dialog">
	<div class="modal-dialog modal-md">
		<div class="modal-content rrailm-modal-content">
			<div class="modal-body">
				<div class="modal-content-header row">
					<div class="col-12">
						<h6 class="float-left confirmation-tittle">Full information</h6>
						<button type="button" class="close float-right rrailm-modal-close" data-dismiss="modal"><span class="rrailm-modal-close-span">&times;</span></button>
					</div>
				</div>
				<div class="row rrailm-modal-body-content">
					<div class="rrailm-mbc-div-sub" ><b>SITE :</b>             <span class="disp-site">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>ID :</b>               <span class="disp-id">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>MERCHANT :</b>         <span class="disp-merchant">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>NORMALIZE ID :</b>     <span class="disp-nmid">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>LINK :</b>             <span class="disp-link">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>PROBLEM :</b>          <span class="disp-prob">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>ON SITE :</b>          <span class="disp-ons">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>ON MERCHANT FEED :</b> <span class="disp-onmf">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>ON MERCHANT SITE :</b> <span class="disp-onms">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>CHECKER FEEDBACK :</b> <span class="disp-cfeedback">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>CHECKER :</b>          <span class="disp-checker">AKS</span></div>
					<div class="rrailm-mbc-div-sub"><b>DATE COMPLETED :</b>   <span class="disp-datecompleted">AKS</span></div>
				</div>
			</div>
			<div class="modal-footer">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content custm-bg">
			<div class="modal-body display-res">
				<div class="d-flex alsmm-mb-div">
					<div class="h3 mer-id">Merchant</div>
					<div class="h3 total-c">Total</div>
				</div>
				<div class="row">
					<div class="col-md-12">
...
<!-- price check add shift modal -->
<div class="modal fade" id="pc-add-shift-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content pcasm-modal-content">
			<div class="modal-header">
				<h5 class="modal-title modal-assign-title-txt" id="exampleModalLabel">Add Shift</h5>
				<button type="button" class="close float-right pcasm-modal-close" data-dismiss="modal"><span class="pcasm-modal-close-span">&times;</span></button>
			</div>
			<div class="modal-body pc-asb-modal">
				<div class="form-group">
					<label class="pcasm-mb-label-week-days">Week Day's Schedule</label>
					<select class="form-control select-checker" id="sel1">
						<option selected disabled>Assign Worker</option>
					</select>
				</div>
				<div class="form-group">
					<div class="row pcasm-mb-time-div-1">
						<div class="col-md-3 pcasm-mb-time-div-1-sub-1">Start</div>
						<div class="col-md-3">
						...
						<div class="col-md-3 pcasm-mb-time-div-1-sub-3">
				...
				<div class="form-group">
					<div class="row pcasm-mb-time-div-2">
						<div class="col-md-3 pcasm-mb-time-div-2-sub-1">End</div>
						<div class="col-md-3">
						...
						<div class="col-md-3 pcasm-mb-time-div-2-sub-3">
				...
				<label class="pcasm-mb-label-week-ends">Sunday's Schedule</label>
				<div class="form-group">
					<div class="row pcasm-mb-time-div-3">
						<div class="col-md-3 pcasm-mb-time-div-3-sub-1">Start</div>
						<div class="col-md-3">
						...
						<div class="col-md-3 pcasm-mb-time-div-3-sub-3">
				...
				<div class="form-group">
					<div class="row pcasm-mb-time-div-4">
						<div class="col-md-3 pcasm-mb-time-div-4-sub-1">End</div>
						<div class="col-md-3">
						...
						<div class="col-md-3 pcasm-mb-time-div-4-sub-3">
...
<!-- price check add daily listing modal -->
<div class="modal fade" id="price_check_tool_modal_add_game" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content pcdl-modal-content">
			<div class="modal-header">
				<h5 class="modal-title modal-daily-title-txt" id="exampleModalLabel">Add Game To Check</h5>
				<button type="button" class="close float-right pcdl-mc-close" data-dismiss="modal" >
					<span class="pcdl-mc-close-span">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<div class="form-group">
					<label class="pcdl-mb-game-info">Game Info</label>
					<div class="row">
						<div class="col-md-6"><label>Game ID</label></div>
						<div class="col-md-6"><span class="err-msg"></span></div>
					</div>
					<input type="text" id="price_check_tool_game_id" class="form-control">
					<label>Game Name</label>
					<input type="text" id="price_check_tool_game_name" class="form-control">
				</div>

				<label class="release-date-label" for="release-date">Release Date</label>
				<div class="form-group">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="close float-right awalm-modal-close" data-dismiss="modal">
					<span class="awalm-modal-close-span">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<div class="form-group">
...
<div class="modal fade" id="alert-modal" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content alert-modal-bg">
			<div class="modal-body">
...
<div class="modal fade" id="show-add-log-modal" role="dialog">
	<div class="modal-dialog modal-md">
		<div class="modal-content addcl-modal-content">
			<div class="modal-body">
				<div class="modal-content-header row">
					<div class="col-12">
						<h6 class="float-left confirmation-tittle">Create Changelog</h6>
						<button type="button" class="close float-right addcl-modal-close" data-dismiss="modal">
							<span class="addcl-modal-close-span">&times;</span>
						</button>
					</div>
				</div>
				<div class="row">
					<div class="col-12 modal-content-body">
						<div class="row">
							...
							<div class="col-6">
								<div class="user-input-wrp">
									<br/>
									<input type="text" value='' class="inputText changelog-date-txt" onkeyup="this.setAttribute('value', this.value);" disabled/>
						...
						<br>
						<div>
							<textarea class="changelog-msg-txtarea"></textarea>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="add-div-store col-sm-12">
					...
					<table id="add-merchant-table" class="table">
						<thead>
							<th>Merchant</th>
							<th>Id</th>
							<th class="fee-thead-th-site">Site</th>
						</thead>
						<tbody>
							<tr>
				...
				<div class="display-more-fees col-sm-12 mt-3">
					<div class="display-pp">
						<div class="title-fees">
							<div class="title-paypal">Paypal Fees</div>
							<div class="add-paypal-row" data-row="paypal">+ row</div>
						</div>
					...
					<div class="display-cc">
						<div class="title-fees">
							<div class="title-card">Card Fees</div>
							<div class="add-card-row" data-row="card">+ row</div>
						</div>
