			...
			<div class="wrapper" id="wrapper">
				...
				<!-- <div class="float-anywhere" id="float-anywhere">
					...
					<div class="float-settings-menu">
						<a href="<?= PROOT ?>dashboard/activities" style="color: #fff;text-decoration: none;"><i class="fas fa-history float-settings-icon" data-toggle="tooltip" title="Activity logs"></i></a>
					</div>
					<div class="float-settings-menu" id="btn-create-report">
						<i class="fas fa-bullhorn float-settings-icon" data-toggle="tooltip" title="Create report"></i>
					</div>
