...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-4 mtop-35px">
			<div class="card card-style">
				<div class="card-header no-padding row-3-card-header"> 
					<div class="card-div-overflow-style row-3-card-div-overflow-style row-3-card-div-overflow-style-1"> </div>
				</div>
				<div class="card-body">
		...
		<div class="col-md-4 mtop-35px">
			<div class="card card-style">
				<div class="card-header no-padding row-3-card-header"> 
					<div class="card-div-overflow-style row-3-card-div-overflow-style row-3-card-div-overflow-style-2"> </div>
				</div>
				<div class="card-body">
		...
		<div class="col-md-4 mtop-35px">
			<div class="card card-style">
				<div class="card-header no-padding row-3-card-header"> 
					<div class="card-div-overflow-style row-3-card-div-overflow-style row-3-card-div-overflow-style-3"> </div>
				</div>
				<div class="card-body">
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-12 mtop-35px">
			<div class="card card-style">
				<div class="card-body no-padding row-4-card-body"> 
					<div class="card-div-overflow-style row-4-card-div-overflow-style row-4-card-div-overflow-style-2"> </div>
				</div>
			</div>
		</div>
	</div>
