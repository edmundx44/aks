...
<script type="text/javascript">
	...
	// var $url = url+'links/affiliateCheck';
	// var globalSite = null;
 ...
 //       		if(!btn){
	...
	// 		$.ajax({
	// 			url:"<?=PROOT?>links/affiliateCheck",  
	// 			method:"POST",
	// 			dataType:'JSON',
	// 			data:{
	// 				action:'affMoreInfo',
	...
	// 	var href = '<?=PROOT?>links/affiliateCheck'; //for goto
	// 	$('.div-errors-alc').show();
	// 	$('.div-search-alc').show();
 ...
 //    	var newPath = path.replace(/akss\/links\/affiliateCheck/,'');
