const $dataReq = { action: 'metacriticsErrorRating' };
var criticsTable = $('#table-metacritics-error-rating').DataTable();
$(function (){
...
function ajaxSuccess(data){
	...
	if(ajaxMetacriticResponse != null){
		criticsTable = $('#table-metacritics-error-rating').DataTable({
			destroy: true,
			responsive: true,
			pageLength: 25,
